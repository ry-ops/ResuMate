...
<head>
    ...
    <title>Document - Generated by ATSFlow</title>
    <style>
        body {
...
<body>
    ...
    <footer style="margin-top: 40px; padding-top: 20px; border-top: 1px solid #eee; font-size: 12px; color: #999;">
        Generated by ATSFlow on ${new Date().toLocaleDateString()}
    </footer>
</body>
</html>`;
    }
...
Generated with ATSFlow - AI-Powered Resume Optimization
https://github.com/ry-ops/ATSFlow
